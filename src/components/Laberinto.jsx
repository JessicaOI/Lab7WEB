...
const Laberinto = ({setGanar}) => {
    ...
    const loadLaberinto = async () => {
        ...
        let fet = "https://maze.juanelcaballo.club/?type=json&w="+alto+"&h="+ancho
        ...
        overflowX: 'hidden' }}>
...

            {
                laberinto.map((row,rowIndex) => {
                    ...
                    return (
                        <div key = {rowIndex} css= {{ display: 'flex',
                        flexDirection: 'row',
                        justifyContent: 'center'}}>

                        {
                            row.map((column,columnIndex) => {
                                ...
                                if(column === '+' || column === '-' || column === '|' ){
                                    ...
                                    return (
                                        <Jugador key={'player'} state={jugador} />
                                    )
                                }if(column === 'g'){
                                    
                                    return (
                                        <div key = {columnIndex} 
                                        css = {{backgroundImage: `url(${final})`,
                                        height: '45px',
                                        width: '45px',
                                        backgroundSize: 'contain'}}/>
                                    )
